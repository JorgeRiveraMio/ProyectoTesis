...
namespace ProyectoTesis.Migrations
{
    ...
    [Migration("20251010172758_ActualizacionRailway")]
    partial class ActualizacionRailway
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoTesis.Models.TBM_ESTUDIANTE", b =>
                {
                    b.Property<Guid>("IDD_ESTUDIANTE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("NUM_EDAD")
                        .HasColumnType("integer");

                    b.HasKey("IDD_ESTUDIANTE");

                    b.HasIndex("IDD_SESION")
                        .IsUnique();

                    b.ToTable("TBM_ESTUDIANTES", (string)null);
                });
            ...
            modelBuilder.Entity("ProyectoTesis.Models.TBM_ESTUDIANTE", b =>
                {
                    b.HasOne("ProyectoTesis.Models.TBM_SESION", "SESION")
                        .WithOne()
                        .HasForeignKey("ProyectoTesis.Models.TBM_ESTUDIANTE", "IDD_SESION")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
